...
function addValueTodo(e) {
    ...
    let listFav = listWrapper.querySelector("#listFav");
    listFav.addEventListener("click", function(e) {
        listFav.classList.toggle("bg-yellow-200");
